...
WISHLIST_ACCOUNT_REQUIRED = True
...
#     ("Catalog", ("catalog.Book", "catalog.People", "catalog.Branch", "catalog.BookAuthor", "catalog.Format", "catalog.Genre", "catalog.Language", "catalog.Publisher", "catalog.Role")),
#     ("Calendar", ("calendars.Event", "calendars.EventRelation", "calendars.EventCategory", "calendars.Occurrence", "calendars.Rule"))    
#     )
...
ALLOWED_HOSTS = ['fishbb.pythonanywhere.com']
...
# STATICFILES_DIRS = (
#     os.path.join(PROJECT_APP_PATH, "static").replace('\\', '/'),
# )
...
ACCOUNTS_APPROVAL_EMAILS = 'loudan@protonmail.com'
